...
public class ArticleController : IDynamicApiController
{
    ...
    private readonly IRepository<AuthAccount> _authAccountRepository;
    private readonly IRepository<FriendLink> _friendLinkRepository;

    public ArticleController(IRepository<Tags> tagsRepository,
        IRepository<Article> articleRepository,
        AuthManager authManager,
        IRepository<Categories> categoryRepository,
        IRepository<AuthAccount> authAccountRepository,
    ...
    /// <returns></returns>
    [HttpGet]
    public async Task<PagedList<ArticleOutput>> Get([FromQuery] ArticleListQueryInput dto)
    {
